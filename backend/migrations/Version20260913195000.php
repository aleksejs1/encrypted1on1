...
/**
 * Denormalizes company_id onto anketas (GitHub issue #69) for machine-enforced
 * multi-tenant isolation via CompanyFilter. Backfills existing anketas from the
 * employee's company_id.
 */
    ...
    public function up(Schema $schema): void
    {
        $this->addSql(<<<'SQL'
            ...
            SELECT id, meetingDate, employeeSealedKey, managerSealedKey, employeeSealedKeyUpdatedAt,
              ...
              outcomesVersion, goalCheckpointsBlob, goalCheckpointsVersion, createdAt, formVersion, employee_id,
              manager_id, employeeBlobVersion, managerBlobVersion
            FROM anketas
        SQL);
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE anketas (
              ...
              employeeBlobVersion INTEGER NOT NULL,
              managerBlobVersion INTEGER NOT NULL,
              ...
              CONSTRAINT FK_865B0D84979B1AD6 FOREIGN KEY (company_id) REFERENCES companies (id) NOT DEFERRABLE INITIALLY IMMEDIATE
            )
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO anketas (
              ...
              archivedAt, reminderSentAt, missed, periodicityDays, commentsBlob, commentsVersion, outcomesBlob,
              outcomesVersion, goalCheckpointsBlob, goalCheckpointsVersion, createdAt, formVersion, employee_id,
              manager_id, employeeBlobVersion, managerBlobVersion, company_id
            )
            SELECT id, meetingDate, employeeSealedKey, managerSealedKey, employeeSealedKeyUpdatedAt,
              managerSealedKeyUpdatedAt, employeeBlob, employeePublishedAt, managerBlob, managerPublishedAt,
              archivedAt, reminderSentAt, missed, periodicityDays, commentsBlob, commentsVersion, outcomesBlob,
              outcomesVersion, goalCheckpointsBlob, goalCheckpointsVersion, createdAt, formVersion, employee_id,
              manager_id, employeeBlobVersion, managerBlobVersion,
              (SELECT u.company_id FROM users u WHERE u.id = __temp__anketas.employee_id)
